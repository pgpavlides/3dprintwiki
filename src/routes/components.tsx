      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <input
              ...
              className="px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent w-64"
            />
          </div>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
          <div className="p-8 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Choosing Components</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Material Considerations</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Size Standards</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Installation Methods</h3>
                <p className="text-gray-600">
          ...
          <div className="p-8 bg-white rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Design Guidelines</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Assembly Tips</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-1">

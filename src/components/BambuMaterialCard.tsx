      ...
      <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-950 shadow-lg dark:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-emerald-500/10">
        ...
        <div className="relative p-6">
          ...
          <div className="mt-8 flex gap-3">
            ...
            <button className="flex items-center justify-center gap-2 rounded-xl bg-gray-100 dark:bg-slate-900 px-4 py-3 font-semibold text-gray-900 dark:text-white transition-colors hover:bg-gray-200 dark:hover:bg-slate-800">
